function [] = XTALFIT(datax,datay,dataz)
...
%     xui.ax(1) = axes('Parent',xui.fh,'Units','pixels','Xlim',[minRange,maxRange],'Ylim',[ymin ymax],...
%         'YTickLabel',['0' '15' '30' '45' '60' '75' '90' '105' '120' '135' '150' '165' '180' '195' '210' '225' '240' '255' '270' '285' '300' '315' '330' '345' '360'],...
%         'XTickLabel',['-3000','-2000','-1000','0','1000','2000','3000'],...
%         'Position',[fhleft+25 fhbottom+50 fhwidth*0.2 fhheight*0.70]); %,'String','Rotation about xtal x-axis'
%     xlabel(xui.ax(1),'ppm');
%     ylabel(xui.ax(1),'rotation angle (THETA)');
...
%     xui.ax(2) = axes('Parent',xui.fh,'Units','pixels','Xlim',[minRange,maxRange],'Ylim',[ymin ymax],...
%         'YTickLabel',['0' '15' '30' '45' '60' '75' '90' '105' '120' '135' '150' '165' '180' '195' '210' '225' '240' '255' '270' '285' '300' '315' '330' '345' '360'],...
%         'XTickLabel',['-3000','-2000','-1000','0','1000','2000','3000'],...
%         'Position',[fhleft+25+fhwidth*0.2+55 fhbottom+50 fhwidth*0.2 fhheight*0.70]); %,'Title','Rotation about xtal y-axis'
%     xlabel(xui.ax(2),'ppm');
%     ylabel(xui.ax(2),'rotation angle (THETA)');
...
%     xui.ax(3) = axes('Parent',xui.fh,'Units','pixels','Xlim',[minRange,maxRange],'Ylim',[ymin ymax],...
%         'YTickLabel',['0' '15' '30' '45' '60' '75' '90' '105' '120' '135' '150' '165' '180' '195' '210' '225' '240' '255' '270' '285' '300' '315' '330' '345' '360'],...
%         'XTickLabel',['-3000','-2000','-1000','0','1000','2000','3000'],...
%         'Position',[fhleft+25+2*fhwidth*0.2+110 fhbottom+50 fhwidth*0.2 fhheight*0.70]); %,'Title','Rotation about xtal z-axis'
%     xlabel(xui.ax(3),'ppm');
%     ylabel(xui.ax(3),'rotation angle (THETA)');
...
%     xui3pos = get(ax3,'Position');
    ...
    %x-angles
    xui.txta(1) = uicontrol('style','text','string','alpha','units','normalized','position',[(ax1l+ax1w-0.50*ax1w)/fhwidth (ax1h+ax1b+90)/fhheight 0.25*ax1w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(1) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax1l+ax1w-0.25*ax1w)/fhwidth (ax1h+ax1b+90)/fhheight 0.25*ax1w/fhwidth 25/fhheight]); %,'fontsize',10);

    xui.txta(2) = uicontrol('style','text','string','beta','units','normalized','position',[(ax1l+ax1w-0.50*ax1w)/fhwidth (ax1h+ax1b+65)/fhheight 0.25*ax1w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(2) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax1l+ax1w-0.25*ax1w)/fhwidth (ax1h+ax1b+65)/fhheight 0.25*ax1w/fhwidth 25/fhheight]); %,'fontsize',10);

    xui.txta(3) = uicontrol('style','text','string','gamma','units','normalized','position',[(ax1l+ax1w-0.50*ax1w)/fhwidth (ax1h+ax1b+40)/fhheight 0.25*ax1w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(3) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax1l+ax1w-0.25*ax1w)/fhwidth (ax1h+ax1b+40)/fhheight 0.25*ax1w/fhwidth 25/fhheight]); %,'fontsize',10);

    %y-angles
    xui.txta(4) = uicontrol('style','text','string','alpha','units','normalized','position',[(ax2l+ax2w-0.5*ax2w)/fhwidth (ax2h+ax2b+90)/fhheight 0.25*ax2w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(4) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax2l+ax2w-0.25*ax2w)/fhwidth (ax2h+ax2b+90)/fhheight 0.25*ax2w/fhwidth 25/fhheight]); %,'fontsize',10);

    xui.txta(5) = uicontrol('style','text','string','beta','units','normalized','position',[(ax2l+ax2w-0.5*ax2w)/fhwidth (ax1h+ax1b+65)/fhheight 0.25*ax2w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(5) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax2l+ax2w-0.25*ax2w)/fhwidth (ax1h+ax1b+65)/fhheight 0.25*ax2w/fhwidth 25/fhheight]); %,'fontsize',10);

    xui.txta(6) = uicontrol('style','text','string','gamma','units','normalized','position',[(ax2l+ax2w-0.5*ax2w)/fhwidth (ax1h+ax1b+40)/fhheight 0.25*ax1w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(6) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax2l+ax2w-0.25*ax2w)/fhwidth (ax1h+ax1b+40)/fhheight 0.25*ax1w/fhwidth 25/fhheight]); %,'fontsize',10);

    % z-angles
    xui.txta(7) = uicontrol('style','text','string','alpha','units','normalized','position',[(ax3l+ax3w-0.5*ax3w)/fhwidth (ax3h+ax3b+90)/fhheight 0.25*ax3w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(7) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax3l+ax3w-0.25*ax3w)/fhwidth (ax3h+ax3b+90)/fhheight 0.25*ax3w/fhwidth 25/fhheight]); %,'fontsize',10);

    xui.txta(8) = uicontrol('style','text','string','beta','units','normalized','position',[(ax3l+ax3w-0.5*ax3w)/fhwidth (ax3h+ax3b+65)/fhheight 0.25*ax3w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(8) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax3l+ax3w-0.25*ax3w)/fhwidth (ax3h+ax3b+65)/fhheight 0.25*ax3w/fhwidth 25/fhheight]); %,'fontsize',10);

    xui.txta(9) = uicontrol('style','text','string','gamma','units','normalized','position',[(ax3l+ax3w-0.5*ax3w)/fhwidth (ax3h+ax3b+40)/fhheight 0.25*ax3w/fhwidth 25/fhheight],'fontsize',10);
    xui.txtb(9) = uicontrol('style','text','string',num2str(0),'units','normalized','position',[(ax3l+ax3w-0.25*ax3w)/fhwidth (ax3h+ax3b+40)/fhheight 0.25*ax3w/fhwidth 25/fhheight]); %,'fontsize',10);
...
%     xui = addcomponents(minRange,maxRange,ymin,ymax,initvalues,minvalues,maxvalues);
% 
%     % Make the figure visible after the components have been added
%     set(xui.fh,'Visible','on')
%     
%     plot(xui.ax(1),realdatax(:,1),realdatax(:,2),'.k')
%     set(xui.ax(1),'YTick',[0 15 30 45 60 75 90 105 120 135 150 165 180 195 210 225 240 255 270 285 300 315 330 345 360])
%     axis(xui.ax(1),[min(Range) max(Range) ymin ymax])
%     hold(xui.ax(1),'on') %note that "hold on" and "hold off" do not produce messages in the command window
% 
%     for i=2:dimtempx(2)/2
%         j=2*i-1;
%         plot(xui.ax(1),realdatax(:,j),realdatax(:,j+1),'.k')
%     end
%     
%     hold(xui.ax(1),'off')
% %     xlabel('ppm') 
...
% %     title('Rotation about Xtal X-Axis')
% 
%     plot(xui.ax(2),realdatay(:,1),realdatay(:,2),'.k')
%     set(xui.ax(2),'YTick',[0 15 30 45 60 75 90 105 120 135 150 165 180 195 210 225 240 255 270 285 300 315 330 345 360])
%     axis(xui.ax(2),[min(Range) max(Range) ymin ymax])
%     hold(xui.ax(2),'on') 
%     
%     for i=2:dimtempy(2)/2
%         j=2*i-1;
%         plot(xui.ax(2),realdatay(:,j),realdatay(:,j+1),'.k')
%     end
%     
%     hold(xui.ax(2),'off')
% %     xlabel('ppm') 
...
% %     title('Rotation about Xtal Y-Axis') 
% 
%     plot(xui.ax(3),realdataz(:,1),realdataz(:,2),'.k')
%     set(xui.ax(3),'YTick',[0 15 30 45 60 75 90 105 120 135 150 165 180 195 210 225 240 255 270 285 300 315 330 345 360])
%     axis(xui.ax(3),[min(Range) max(Range) ymin ymax])
%     hold(xui.ax(3),'on') 
%     
%     for i=2:dimtempz(2)/2
%         j=2*i-1;
%         plot(xui.ax(3),realdataz(:,j),realdataz(:,j+1),'.k')
%     end
%      
%     hold(xui.ax(3),'off')
% %     xlabel('ppm') 
...
R = Rot*Rg*Rb*Ra*Orient; %rotation matrix

Minp=R*Min*(R\I0); %1st tensor
%Min2 = [Min(1,1) Min(1,2) -1*Min(1,3);Min(2,1) Min(2,2) Min(2,3);-1*Min(3,1) Min(3,2) Min(3,3)]; %2nd tensor dxy=dyx=dzy=dyz=0 (considering 2 tensors in xz-plane)
%Min2p=R*Min2*(R\I0); %2nd tensor with negative xz-components of 1st tensor
...
function [] = pb_load_xdata(varargin)
    ...
    Tenval = OUT_data.ten; %new lab-frame tensor (from TENSOR.rot)
    ...
    set(S.sl(3),'value',Tenval(1,1));  % get the value for Txx.
    set(S.ed(3),'str',num2str(Tenval(1,1)));
    set(S.sl(4),'value',Tenval(2,2));  % get the value for Tyy.
    set(S.ed(4),'str',num2str(Tenval(2,2)));
    set(S.sl(5),'value',Tenval(3,3));  % get the value for Tzz.
    set(S.ed(5),'str',num2str(Tenval(3,3)));
    set(S.sl(6),'value',Tenval(1,2));  % get the value for Txy.
    set(S.ed(6),'str',num2str(Tenval(1,2)));
    set(S.sl(7),'value',Tenval(1,3));  % get the value for Txz.
    set(S.ed(7),'str',num2str(Tenval(1,3)));
    set(S.sl(8),'value',Tenval(2,3));  % get the value for Tyz.
    set(S.ed(8),'str',num2str(Tenval(2,3)));
    ...
    Fitx = updatefig(Tenval,Orienitx,Orienitxang(1),Orienitxang(2),Orienitxang(3),Orienitxang(4),h,w);
    ...
    for i=2:dimtem(2)/2
        ...
        tempx=updatefig(Tenval,Orienitx,Orienitxang(1),Orienitxang(2),Orienitxang(3),THET,h,w); %call the main fitting function for each theta
        plot(tempx(:,1),tempx(:,2)+theta(j),'r',realdatax(:,j),realdatax(:,j+1),'.k')
    end
...
function [] = pb_load_ydata(varargin)
    ...
    %update the figure (calculate new tensor, x,y,z plots and fits)
    Fity = updatefig(Tenval,Orienity,Orienityang(1),Orienityang(2),Orienityang(3),Orienityang(4),h,w);
    ...
    for i=2:dimtem(2)/2
        ...
        Fity=updatefig(Tenval,Orienity,Orienityang(1),Orienityang(2),Orienityang(3),THET,h,w); %call the main fitting function for each theta
...
%update sliders and editboxes to the New Euler angles (from XTALFIT)
    ...
    %update the figure (calculate new tensor, x,y,z plots and fits)
    Fitz = updatefig(Tenval,Orienitz,Orienitzang(1),Orienitzang(2),Orienitzang(3),Orienitzang(4),h,w);
    ...
    for i=2:dimtem(2)/2
        ...
        Fitz = updatefig(Tenval,Orienitz,Orienitzang(1),Orienitzang(2),Orienitzang(3),THET,h,w);
...
function [] = pb_load_alldata(varargin)
    ...
    tempx=updatefig(Tenval,Orienitx,Orienitxang(1),Orienitxang(2),Orienitxang(3),Alldata.ang(4,1)*pi/180,h,w); 
    subplot('position',[(fhleft+25)/fhwidth (fhbottom+50)/fhheight (fhwidth*0.2)/fhwidth fhheight*0.70/fhheight])
    plot(tempx(:,1),tempx(:,2)+theta(1),'r',realdatax(:,1),realdatax(:,2),'.k')
    set(gca,'YTick',[0 15 30 45 60 75 90 105 120 135 150 165 180 195 210 225 240 255 270 285 300 315 330 345 360])
    axis([min(Range),max(Range),ymin,ymax])
    ...
    for i=2:dimtem(2)/2
        ...
        tempx=updatefig(Tenval,Orienitx,Orienitxang(1),Orienitxang(2),Orienitxang(3),Thet,h,w);
        plot(tempx(:,1),tempx(:,2)+theta(j),'r',realdatax(:,j),realdatax(:,j+1),'.k')
    end
    ...
    tempy=updatefig(Tenval,Orienity,Orienityang(1),Orienityang(2),Orienityang(3),Alldata.ang(4,2)*pi/180,h,w); 
    subplot('position',[(fhleft+25+fhwidth*0.2+65)/fhwidth (fhbottom+50)/fhheight fhwidth*0.2/fhwidth fhheight*0.70/fhheight])
    plot(tempy(:,1),tempy(:,2)+theta(1),'r',realdatay(:,1),realdatay(:,2),'.k')
    set(gca,'YTick',[0 15 30 45 60 75 90 105 120 135 150 165 180 195 210 225 240 255 270 285 300 315 330 345 360])
    axis([min(Range),max(Range),ymin,ymax])
    ...
    for i=2:dimtem(2)/2
        ...
        tempy=updatefig(Tenval,Orienity,Orienityang(1),Orienityang(2),Orienityang(3),Thet,h,w);
        plot(tempy(:,1),tempy(:,2)+theta(j),'r',realdatay(:,j),realdatay(:,j+1),'.k')
    end
    hold off
    xlabel('ppm') 
    ...
    tempz=updatefig(Tenval,Orienitz,Orienitzang(1),Orienitzang(2),Orienitzang(3),Alldata.ang(4,3)*pi/180,h,w); 
    subplot('position',[(fhleft+25+2*fhwidth*0.2+130)/fhwidth (fhbottom+50)/fhheight fhwidth*0.2/fhwidth fhheight*0.70/fhheight])
    plot(tempz(:,1),tempz(:,2)+theta(1),'r',realdataz(:,1),realdataz(:,2),'.k')
    set(gca,'YTick',[0 15 30 45 60 75 90 105 120 135 150 165 180 195 210 225 240 255 270 285 300 315 330 345 360])
    axis([min(Range),max(Range),ymin,ymax])
    ...
    for i=2:dimtem(2)/2
        ...
        tempz=updatefig(Tenval,Orienitz,Orienitzang(1),Orienitzang(2),Orienitzang(3),Thet,h,w);
        plot(tempz(:,1),tempz(:,2)+theta(j),'r',realdataz(:,j),realdataz(:,j+1),'.k')
    end
    hold off
    xlabel('ppm') 
...
% Callback for pushbutton.  Displays slider values at command line.
global dimtemp
xtalfit=zeros(length(dimtemp)/2,3);
angl=(0:360/999:360)';
STR = varargin{3}; % Get structure

val1=get(STR.sl(1),'value'); % get the 1st slider value
val2=get(STR.sl(2),'value'); %   "  "  2nd    "     "
val3=get(STR.sl(3),'value'); %   "  "  3rd    "     "
val4=get(STR.sl(4),'value'); %   "  "  4th    "     "
val5=get(STR.sl(7),'value'); %   "  "  6th    "     "
val6=get(STR.sl(8),'value'); %   "  "  7th    "     "

div1=num2str(get(STR.sl(1),'value')); % get the 1st slider value
div2=num2str(get(STR.sl(2),'value')); %   "  "  2nd    "     "
div3=num2str(get(STR.sl(3),'value')); %   "  "  3rd    "     "
div4=num2str(get(STR.sl(4),'value')); %   "  "  4th    "     "
div5=num2str(get(STR.sl(5),'value')); %   "  "  5th    "     "
div6=num2str(get(STR.sl(6),'value')); %   "  "  6th    "     "

switch findobj(get(STR.bg,'selectedobject'))
    case STR.rd(1)
       disp('crystal rotation about [100] starting with [001] || to Bo')
    case STR.rd(2)
       disp('crystal rotation about [100] starting with [010] || to Bo')
    case STR.rd(3)
       disp('crystal rotation about [010] starting with [001] || to Bo')
    case STR.rd(4)
       disp('crystal rotation about [010] starting with [100] || to Bo')
    case STR.rd(5)
       disp('crystal rotation about [001] starting with [100] || to Bo')
    case STR.rd(6)
       disp('crystal rotation about [001] starting with [010] || to Bo')
    otherwise
       disp('Whoops! glitch somewhere')
end        
disp(['dxx (ppm) = ' div1 ', dyy (ppm) = ' div2 ', dzz (ppm) = ' div3 ',dxz (ppm) = +/-' div4]) % Print the slider values to the command line.
disp(['height (au) = ' div5, ', width (ppm) = ' div6])
disp(['alpha offset (degrees) = ' div7 ', beta offset (degrees) = ' div8 ', gamma offset (degrees) = ' div9])
disp(' ')

switch findobj(get(STR.bg(1),'selectedobject'))
    case STR.rd(1)
       Xorientx = 1;
    case STR.rd(2)
       Xorientx = 2;
...
switch findobj(get(STR.bg(2),'selectedobject'))
    case STR.rd(3)
       Xorienty = 3;
    case STR.rd(4)
       Xorienty = 4;
...
switch findobj(get(STR.bg(3),'selectedobject'))
    case STR.rd(5)
       Xorientz = 5;
    case STR.rd(6)
       Xorientz = 6;       
...
for i=1:1000
    xtalfit(i,:)=Fitout(val1,val2,val3,val4,val7,val8,val9,angl(i),Xorient); %call the main fitting function
end

save xtalfit.dat xtalfit -ascii %send xtalfit to file called xtalfit.dat
end %function pb_call(varargin)
%}
%{
%**************************************************************************
function z = Fitout(A1,A2,A3,A23,alph,beta,gamm,ang,Xor) 
%inputs = dxx, dyy, dzz, dxz, gaussian ht, gaussian std, polar offset, azimuthal offset and angle of crystal orientation
%creates a fit to data peaks in frequency versus angle
...
D0 = [A1 0 A23;0 A2 0;A23 0 A3]; %1st general tensor dxy=dyx=dzy=dyz=0
D1 = [A1 0 -A23;0 A2 0;-A23 0 A3]; %2nd tensor dxy=dyx=dzy=dyz=0 (considering 2 tensors in xz-plane)

%Rough Xtal orientations 
if Xor == 1
    Orient = [1 0 0;0 1 0;0 0 1]; %rot about crystal x-axis, with z-xtal along B0 initially (y-xtal along -y-lab)
elseif Xor == 2
    Orient = [1 0 0;0 0 -1;0 1 0]; %rot about crystal x-axis, with y-xtal along B0 initially (z-xtal along -y-lab)
elseif Xor == 3
    Orient = [0 1 0;-1 0 0;0 0 1]; %rot about crystal y-axis, with z-xtal along B0 initially (x-xtal along -y-lab)
elseif Xor == 4
    Orient = [0 1 0;0 0 1;1 0 0]; %rot about crystal y-axis, with x-xtal along B0 initially (z-xtal along y-lab)
elseif Xor == 5
    Orient = [0 0 1;0 -1 0;1 0 0]; %rot about crystal z-axis, with x-xtal along B0 initially (y-xtal along -y-lab)
else
    Orient = [0 0 1;1 0 0;0 1 0]; %rot about crystal z-axis, with y-xtal along B0 initially (x-xtal along y-lab)
end

%Euletr angle offsetts to rough orientations

    Fudge = [1 0 0;0 cos(gamma) -sin(gamma);0 sin(gamma) cos(gamma)]*...
            [cos(beta) 0 -sin(beta);0 1 0;sin(beta) 0 cos(beta)]*...
            [1 0 0;0 cos(alpha) -sin(alpha);0 sin(alpha) cos(alpha)]; 

%Rotations in y-z lab plane
Rot = [1 0 0;0 cos(ang) sin(ang);0 -sin(ang) cos(ang)]; %rotations about lab x-axis

D0lab = Rot*Fudge*Orient*D0*Orient^(-1)*Fudge^(-1)*Rot^(-1);
D1lab = Rot*Fudge*Orient*D1*Orient^(-1)*Fudge^(-1)*Rot^(-1);

f0 = D0lab(3,3); %shift (zz component) of 1st tensor
f1 = D1lab(3,3); %shift (zz component) of 2nd tensor
